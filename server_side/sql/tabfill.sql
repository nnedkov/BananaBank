...
INSERT INTO `USERS` (`email`, `password`, `is_employee`, `is_approved`) VALUES ('client1@mybank.de', 'client1', 0, 1);
INSERT INTO `USERS` (`email`, `password`, `is_employee`, `is_approved`) VALUES ('client1@mybank.de', 'client2', 0, 1);

INSERT INTO `TRANSACTIONS` (`email_src`, `email_dest`, `amount`, `is_approved`) VALUES ('client1@mybank.de', 'client2@mybank.de', 200, 0);
